      ...
      <Slide left >
        <Bounce >
          ...
          <div className="clc_container">
            <Fade top cascade>
            <h1 className="clc_header">I got my start in web design and development from creating and maintaining gaming fan sites as a kid. Since then, I've become interested in all aspects of software engineering. The programming languages I'm focusing on mastering are JavaScript, Java and Python.</h1>
            </Fade>
