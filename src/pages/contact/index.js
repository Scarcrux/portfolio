...
class Contact extends React.Component {
  ...
  componentDidMount() {
    ...
    ReactGa.pageview('jonathanscarpelli.com - Contact Screen');
  }
  ...
  render() {
    return (
      <div>
        <Helmet>
                <meta charSet="utf-8" />
                <title>Contact | Jonathan Scarpelli</title>
                <link rel="canonical" href="http://jonathanscarpelli.com/contact" />
                <meta name="description" content="Jonathan Scarpelli | Contact - Software Engineer" />
        </Helmet>
